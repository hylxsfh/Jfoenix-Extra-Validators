 ...
 * @author hyl
 */
public class FutureOrPresentDateValidator extends ValidatorBase {
    /**
     *
    ...
    public static void createValidator(TextInputControl validateControl, String message, String date) {
        new FutureOrPresentDateValidator(validateControl, message, date);
    }
     ...
     * @param date
     */
    private FutureOrPresentDateValidator(TextInputControl validateControl, String message, String date) {
    ...
    public boolean equals(Object o) {
        ...
        FutureOrPresentDateValidator that = (FutureOrPresentDateValidator) o;
