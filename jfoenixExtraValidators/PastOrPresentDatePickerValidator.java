...
/**
 * 以前或当天日期JFXDatePicker校验类<p></p>
 *
 * @author hyl
 */
public class PastOrPresentDatePickerValidator extends ValidatorBase {
    /**
    ...
    public static void createValidator(JFXDatePicker validateControl, String message, String date) {
        new PastOrPresentDatePickerValidator(validateControl, message, date);
    }
     ...
     * @param date
     */
    private PastOrPresentDatePickerValidator(JFXDatePicker validateControl, String message, String date) {
    ...
    public boolean equals(Object o) {
        ...
        PastOrPresentDatePickerValidator that = (PastOrPresentDatePickerValidator) o;
